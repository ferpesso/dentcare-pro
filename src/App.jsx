...
import PatientManagement from './components/PatientManagementRefactored.jsx'
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                <p className="text-gray-600">Sistema de gestão de tratamentos em desenvolvimento.</p>
              </CardContent>
            </Card>
          </div>
        )
      case 'whatsapp':
        return (
          <div className="space-y-6">
            ...
            <Card>
              <CardContent className="p-6">
                <p className="text-gray-600">Integração com WhatsApp e IA em desenvolvimento.</p>
              </CardContent>
            </Card>
          </div>
        )
